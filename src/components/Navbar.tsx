        ...
        <nav style={{ background: '#fff', borderBottom: '1px solid var(--border)', position: 'sticky', top: 0, zIndex: 50 }}>
            <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2 flex-shrink-0">
                    <div style={{ width: 42, height: 32, borderRadius: 8, background: 'var(--accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 700, fontSize: 15 }}>TOM</div>
